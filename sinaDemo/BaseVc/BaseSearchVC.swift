...
//        collectionView.register(UICollectionSearchCell, bundle: nil), forCellWithReuseIdentifier: SearchCellID)
        collectionView.register(CollectionSearchCell.self, forCellWithReuseIdentifier: SearchCellID)
